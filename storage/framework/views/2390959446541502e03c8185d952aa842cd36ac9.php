                    ...
                    <table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="col-sm-1">
                                    <input type="text" class="form-control" name="moqs<?php echo e($product->id); ?>"  value="1"  required/>
                                </td>
                                <td class="col-sm-1">
                                    <input type="text" class="form-control" name="prices<?php echo e($product->id); ?>" value="<?php echo e($product->cost_of_product); ?>" required/>
