                                ...
                                <div class="row">
                                    <div class="col-sm-2 imgUp">
                                        <div class="imagePreview">
                                            <img id="default" src="<?php echo e((url('storage/'.$product->photo))); ?>" height="100%" width="100%" style="background-color: white">
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\WeDevs\Tedfo Docs\Tdocs\resources\views/pages/products/editProduct.blade.php ENDPATH**/ ?>