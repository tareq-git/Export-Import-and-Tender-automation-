<?php $__env->startSection('content'); ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <form action="<?php echo e(route('shipper.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="card">

                <div class="header">
                    <h2 class="text-secondary"> Create New Shipper profile</h2>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\WeDevs\Tedfo Docs\Tedfo\resources\views/pages/profile/shippers/newShipper.blade.php ENDPATH**/ ?>